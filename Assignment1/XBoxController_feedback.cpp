...
// Feedback: Global variable is very bad idea. Multiple instance of XBoxController would be accsesing the same object leading to data corruption.
XINPUT_STATE State;
...
bool GamePad::XBoxController::IsConnected()
{
	...
	if (dwResult == ERROR_SUCCESS) {
		// Feedback: use lowercase true or false in c++. TRUE and FALSE are macro from C.
		result = TRUE;
	}
	else {
		result = FALSE;
...
{
	// Feedback: Code repetition, use helper function. See DRY principle (Don't repeat yourself).
...
GamePad::Coordinate GamePad::XBoxController::LeftThumbLocation()
{
	...
	if (magnitude > Deadzone)
	{
		...
		// Feedback: Constant should be constexpr or const, not magic number.
...
// Use of programming constructs (0.5 marks) 0
// Consistent and neat structure (1 mark) 1
// Choice of names for variables (0.5 marks) 0.25
// Commenting and readability of the code (1 mark) 0.5
// Good use of OOP (private data/functions) (1 mark) 0.5
// Total: 2.25 / 4
